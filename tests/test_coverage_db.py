...
class TestOhioCountiesDatabaseAndCoverage(unittest.TestCase):
    ...
    def test_coverage_summary_counts(self):
        ...
        self.assertGreaterEqual(s["covered_counties"], 67)
        self.assertGreaterEqual(len(s["both"]), 10)
        self.assertGreaterEqual(len(s["court_only"]), 17)
    ...
    def test_remaining_counties_filters(self):
        ...
        self.assertEqual(len(neither), 21)
        ...
        self.assertEqual(len(court_missing), 61)
    ...
    def test_api_coverage_endpoint(self):
        ...
        self.assertEqual(data["remaining_counties"], 21)
    ...
    def test_api_remaining_endpoint(self):
        ...
        self.assertEqual(len(data["remaining_counties"]), 21)
